...
/**
 * Modelo que representa una reserva / alquiler de habitación.
 */
public class Reserva {
    ...
    private int            usoCamas;     // 1 o 2
    private String         estado;       // ACTIVA | FINALIZADA | EXTENDIDA
    private String         observaciones;

    // Campos adicionales para mostrar en pantalla (JOIN con otras tablas)
    ...
    // Calcula fecha de vencimiento: día siguiente a las 12:00
