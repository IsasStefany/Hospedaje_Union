...
public class MainFrame extends JFrame {
    ...
    private void construirUI() {
        ...
        try {
            java.net.URL resource = getClass().getResource("/habitaciones/logo.png");
            if (resource != null) {
        ...
        sidebar.add(crearMenuBtn("Lavandería", () -> cargarLavanderia()));
    ...
    private void mostrarDetalleHabitacion(Habitacion h) {
        ...
        try {
            ...
            java.net.URL resource = getClass().getResource("/habitaciones/" + tipo.toLowerCase() + ".jpg");
            if (resource != null) {
                ImageIcon icon = new ImageIcon(resource);
                ...
                if (tipo.toLowerCase().startsWith("simple")) {
                    fallbackResource = getClass().getResource("/habitaciones/simple.jpg");
                }
    ...
    private void cargarLavanderia() {
        panelContenido.removeAll();
        panelContenido.add(new PanelLavanderia(usuarioActual));
        panelContenido.revalidate();
        panelContenido.repaint();
    }
